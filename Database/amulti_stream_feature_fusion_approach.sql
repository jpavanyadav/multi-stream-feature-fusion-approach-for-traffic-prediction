...
--
-- Host: localhost
-- Generation Time: Aug 30, 2022 at 12:49 PM
...
--
-- Database: `amulti_stream_feature_fusion_approach`
--
CREATE DATABASE IF NOT EXISTS `amulti_stream_feature_fusion_approach` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `amulti_stream_feature_fusion_approach`;
...
('nikhavi8syk11jnypdm4f83o25abnsd9', 'eyJ1c2VyaWQiOjN9:1oT0aV:lrx865hqx7Xf-0Q2KhixOvCeds5At9TGaow17na2XKs', '2022-09-13 12:43:27.136797'),
...
('q1fd2ssr7kkdneh54r60ow3sbk6gzewp', 'eyJ1c2VyaWQiOjF9:1oSyQi:OYgulyhhyZhayuj1H09omsQ8L5RFiTkgE3MkyDVPiSc', '2022-09-13 10:25:12.489722'),
...
(1, 'Kiran', 'Kiran123@gmail.com', 'Kiran', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(25, 'Naive Bayes', '50.050231062889296'),
(26, 'SVM', '49.82921438617641'),
(27, 'Logistic Regression', '49.869399236487844'),
(28, 'Decision Tree Classifier', '49.166164356037775');
...
(18, 'No Traffic Found', '57.14285714285714'),
(19, 'Traffic Found', '42.857142857142854');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_traffic_prediction_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_traffic_prediction_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `TRAFFIC_DATE` varchar(3000) NOT NULL,
  `TRAFFIC_TIME` varchar(3000) NOT NULL,
  `BOROUGH` varchar(3000) NOT NULL,
  `ZIP_CODE` varchar(3000) NOT NULL,
  `LATITUDE` varchar(3000) NOT NULL,
  `LONGITUDE` varchar(3000) NOT NULL,
  `LOCATION` varchar(3000) NOT NULL,
  `ON_STREET_NAME` varchar(3000) NOT NULL,
  `CROSS_STREET_NAME` varchar(3000) NOT NULL,
  `OFF_STREET_NAME` varchar(3000) NOT NULL,
  `CONTRIBUTING_FACTOR_VEHICLE` varchar(3000) NOT NULL,
  `REFERENCE_ID` varchar(3000) NOT NULL,
  `TRAFFIC_VEHICLE_TYPE_CODE1` varchar(3000) NOT NULL,
  `TRAFFIC_VEHICLE_TYPE_CODE2` varchar(3000) NOT NULL,
  `Junction` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_traffic_prediction_type`
--

INSERT INTO `remote_user_traffic_prediction_type` (`id`, `TRAFFIC_DATE`, `TRAFFIC_TIME`, `BOROUGH`, `ZIP_CODE`, `LATITUDE`, `LONGITUDE`, `LOCATION`, `ON_STREET_NAME`, `CROSS_STREET_NAME`, `OFF_STREET_NAME`, `CONTRIBUTING_FACTOR_VEHICLE`, `REFERENCE_ID`, `TRAFFIC_VEHICLE_TYPE_CODE1`, `TRAFFIC_VEHICLE_TYPE_CODE2`, `Junction`, `Prediction`) VALUES
(1, '29-08-20', '17:10:00', 'BROOKLYN', '11203', '40.64989', '-73.93389', 'POINT (-73.93389 40.64989)', 'NA', 'NA', '4609 SNYDER AVENUE', 'Failure to Yield Right-of-Way', '4342953', 'Sedan', 'Sedan', 'Ghat Road Junction', 'No Traffic Found'),
(2, '29-08-20', '3:29:00', 'NA', 'NA', '40.68231', '-73.84495', 'POINT (-73.84495 40.68231)', 'WOODHAVEN BOULEVARD', 'ARD', 'NA', 'Unspecified', '4342721', 'Station Wagon/Sport Utility Vehicle', 'NA', 'Parallel Road Junction', 'Traffic Found'),
(3, '29-08-20', '22:53:00', 'BROOKLYN', '11249', '40.70166', '-73.961464', 'POINT (-73.961464 40.70166)', 'WILLIAMSBURG STREET WEST', 'WYTHE AVENUE', 'Unspecified', 'Unspecified', '4343074', 'Sedan', 'NA', '2', 'No Traffic Found'),
(4, '29-08-20', '13:00:00', 'BROOKLYN', '11206', '40.699707', '-73.95718', 'POINT (-73.95718 40.699707)', 'BEDFORD AVENUE', 'WALLABOUT STREET', 'NA', 'Driver Inattention/Distraction', '4343077', 'Station Wagon/Sport Utility Vehicle', 'Station Wagon/Sport Utility Vehicle', '4', 'No Traffic Found'),
(5, '29-08-20', '12:29:00', 'BRONX', '10453', '40.861862', '-73.91282', 'POINT (-73.91282 40.861862)', 'WEST FORDHAM ROAD', 'MAJOR DEEGAN EXPRESSWAY', 'NA', 'Pavement Slippery', '4342833', 'Pick-up Truck', 'Station Wagon/Sport Utility Vehicle', '5', 'Traffic Found'),
(6, '29-08-20', '12:30:00', 'BRONX', '10461', '40.848183', '-73.84981', 'POINT (-73.84981 40.848183)', 'NA', '1660 WILLIAMSBRIDGE ROAD', '1660 WILLIAMSBRIDGE ROAD', 'Following Too Closely', '4343262', 'Sedan', 'NA', '3', 'Traffic Found'),
(7, '29-08-20', '0:00:00', 'BRONX', '10459', '40.82472', '-73.89296', 'POINT (-73.89296 40.82472)', 'NA', 'NA', '1047 SIMPSON STREET', 'Unsafe Speed', '4343588', 'Station Wagon/Sport Utility Vehicle', 'Station Wagon/Sport Utility Vehicle', 'Shopping Mall Road', 'No Traffic Found');
